   ...
   public void execute(final User user, NPC npc) {
     ...
     switch (this.type) {
       case BEGIN_QUEST:
         ...
         confirmation.add(new GUIElement(4, Material.PAPER, ChatColor.YELLOW + "Quest Information", ChatColor.GRAY + "Quest: " + ChatColor.RESET + this.quest.getQuestName() + "\n" + 
               ChatColor.GRAY + "Lv Min: " + ChatColor.RESET + this.quest.getLevelMin()));
         confirmation.add(new GUIElement(7, Material.REDSTONE_BLOCK, ChatColor.RED + "✘ " + ChatColor.DARK_RED + ChatColor.BOLD + "Reject", ChatColor.GRAY + "You can always come back later to\n" + 
