...
public enum Rank {
	DEFAULT("Default", "None", "", ChatColor.GRAY, ChatColor.GRAY), BETA_TESTER("Beta Tester", "Beta Tester", ChatColor.WHITE + "[Beta]", ChatColor.GRAY, ChatColor.WHITE),
	...
	MEDIA("Media", "Media", ChatColor.DARK_PURPLE + "[Media]", ChatColor.LIGHT_PURPLE, ChatColor.WHITE),
	CONTENT_TEAM("Content Team", "Content Team", ChatColor.BLUE + "[Content Team]", ChatColor.BLUE, ChatColor.WHITE),
	TRIAL_BUILDER("Trial Builder", "Trial Builder", ChatColor.WHITE + "[Trial Builder]", ChatColor.GRAY, ChatColor.WHITE),
	...
	NEW_GM("New GM", "New GM", ChatColor.GOLD + "[New GM]", ChatColor.GOLD, ChatColor.WHITE), GM("Game Master", "Game Master", ChatColor.GOLD + "[GM]", ChatColor.GOLD, ChatColor.WHITE),
