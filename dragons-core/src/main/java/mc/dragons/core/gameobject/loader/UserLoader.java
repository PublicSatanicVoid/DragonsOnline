 ...
 public class UserLoader extends GameObjectLoader<User> {
   ...
   public User registerNew(Player player) {
     ...
     Document data = (new Document("_id", player.getUniqueId()))
       ...
       .append("maxHealth", Double.valueOf(player.getAttribute(Attribute.GENERIC_MAX_HEALTH).getValue()))
       .append("xp", Integer.valueOf(0))
       .append("level", Integer.valueOf(1))
       .append("rank", Rank.DEFAULT.toString())
       .append("gold", Double.valueOf(0.0D))
       .append("godMode", Boolean.valueOf(false))
       .append("firstJoined", Long.valueOf(System.currentTimeMillis()))
       .append("lastJoined", Long.valueOf(System.currentTimeMillis()))
       .append("lastSeen", Long.valueOf(System.currentTimeMillis()))
       .append("skills", skills)
       .append("skillProgress", skillProgress)
       .append("inventory", new Document())
       .append("quests", new Document())
       .append("vanished", Boolean.valueOf(false))
       ...
       .append("lastReadChangeLog", Integer.valueOf(0))
       .append("ip", player.getAddress().getAddress().getHostAddress())
       .append("totalOnlineTime", Long.valueOf(0L));
