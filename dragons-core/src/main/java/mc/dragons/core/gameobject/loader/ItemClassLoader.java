 ...
 public class ItemClassLoader extends GameObjectLoader<ItemClass> {
   ...
   public ItemClass registerNew(String className, String name, ChatColor nameColor, Material material, int levelMin, double cooldown, double speedBoost, boolean unbreakable, boolean undroppable, double damage, double armor, List<String> lore, int maxStackSize) {
     lazyLoadAll();
