 ...
 public class EntityHider implements Listener {
   ...
   private static final PacketType[] ENTITY_PACKETS = new PacketType[] { 
       ...
       PacketType.Play.Server.REL_ENTITY_MOVE, PacketType.Play.Server.ENTITY_LOOK, PacketType.Play.Server.ENTITY_MOVE_LOOK, PacketType.Play.Server.ENTITY_MOVE_LOOK, 
       ...
       PacketType.Play.Server.ENTITY_EFFECT, PacketType.Play.Server.REMOVE_ENTITY_EFFECT, PacketType.Play.Server.BLOCK_BREAK_ANIMATION, PacketType.Play.Server.UPDATE_ENTITY_NBT, PacketType.Play.Server.COMBAT_EVENT };
   ...
   public EntityHider(Plugin plugin, Policy policy) {
     ...
     plugin.getServer().getPluginManager().registerEvents(
         this.bukkitListener = constructBukkit(), plugin);
     this.manager.addPacketListener(
         (PacketListener)(this.protocolListener = constructProtocol(plugin)));
   }
   ...
   private PacketAdapter constructProtocol(Plugin plugin) {
     return new PacketAdapter(plugin, ENTITY_PACKETS) {
         public void onPacketSending(PacketEvent event) {
           ...
           if (entityID != null && 
             !EntityHider.this.isVisible(event.getPlayer(), entityID.intValue()))
